...
<?php _e( 'Skip to content', 'newsbulk' ); ?></a>
    <div class="wrapper">
        ...
        <div class="container-fluid">
          <!-- Right nav -->
                    <div class="m-header align-items-center">
                        ...
                        <!-- navbar-toggle -->
                        <button class="navbar-toggler mx-auto" type="button" data-toggle="collapse" data-target="#navbar-wp" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="<?php esc_attr_e('Toggle navigation','newsbulk'); ?>">
...
<section class="mg-tpt-tag-area">
 ...
 do_action('newsbulk_action_front_page_main_section_1'); ?>